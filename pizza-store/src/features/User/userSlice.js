...
const userSlice = createSlice({
  ...
  .addCase(fetchAddress.rejected, (state,action) => { state.error = action.error.message; state.status = 'error'; state.error= 'There was a problem with this address make sure to fill the field';})	
});
